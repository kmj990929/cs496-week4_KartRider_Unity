...
public class FeedbackFlashHUD : MonoBehaviour
{
    ...
    photonManager m_GameFlowManager;
    ...
    void Start()
    {
        ...
        m_GameFlowManager = FindObjectOfType<photonManager>();
        DebugUtility.HandleErrorIfNullFindObject<photonManager, FeedbackFlashHUD>(m_GameFlowManager, this);
