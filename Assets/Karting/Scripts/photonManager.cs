...
public class photonManager : MonoBehaviourPunCallbacks
{
    ...
    public bool boostCanStart = false;
    ...
    void Start()
    {
        ...
        main_Audio.clip = bazzi;
        main_Audio.volume = 0.5F;
    ...
    private void Player()
    {
        ...
        Debug.Log(num);
        Vector3 playerInitLocation = new Vector3(11 + num * 2, 1.01f, 1.5f);
    ...
    void Update()
    {
        ...
        //booster
        if (Input.GetKey(KeyCode.UpArrow) && !isBoost && boostCanStart)
        {
    ...
    void EndGame(bool win)
    {
        ...
        if (win) //이겼을 때 
        {
            ...
            // play a sound on win
            var m1_audioSource = gameObject.AddComponent<AudioSource>();
            m1_audioSource.clip = victorySound;
            m1_audioSource.playOnAwake = false;
            m1_audioSource.outputAudioMixerGroup = AudioUtility.GetAudioGroup(AudioUtility.AudioGroups.HUDVictory);
            m1_audioSource.PlayScheduled(AudioSettings.dspTime + delayBeforeWinMessage);
        ...
        {
            var m1_defeataudioSource = gameObject.AddComponent<AudioSource>();
            m1_defeataudioSource.clip = defeatSound;
            m1_defeataudioSource.playOnAwake = false;
            m1_defeataudioSource.outputAudioMixerGroup = AudioUtility.GetAudioGroup(AudioUtility.AudioGroups.HUDVictory);
            m1_defeataudioSource.PlayScheduled(AudioSettings.dspTime + delayBeforeWinMessage);
